...
var style_RELITTIESTRADERURALIDIPROGETTO = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelFill = 'rgba(255,0,200,1.0)';
    ...
    if (feature.get("DENOMINAZIONE DI PROGETTO") !== null) {
        labelText = String(feature.get("DENOMINAZIONE DI PROGETTO"));
    }
        var style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(255,0,200,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 5.699999999999999}),
